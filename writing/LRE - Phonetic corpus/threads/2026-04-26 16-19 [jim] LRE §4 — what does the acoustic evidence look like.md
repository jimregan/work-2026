...
from: Jim O'Regan
date: 2026-04-26 16:19
message_id: 4FD888C9-78A8-4288-93C6-16C085C2456B@localhost
---

← [[2026-04-26 16-16 [jim] LRE §4 — what does the acoustic evidence look like]]
→ [[2026-04-26 16-53 [claude] LRE §4 — how does a rule get higher weight than an]]

An important aspect of this is that we do not treat the phonological rules as axiomatic, any more than we do pronunciations: we consider their application potential evidence of the rule’s validity — we seek verification of the rules as much as of the entries.

> On 26 Apr 2026, at 18:16, Jim O'Regan <you@localhost> wrote:
> 
