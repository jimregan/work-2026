...
A somewhat related idea is the lie-to-children, the sort of gross over-simplification or pure fiction that's used to provide a narrative structure to aid memory. We all know the story about the apple falling on Newton's head: there never was any such apple, but the connection between Newton and gravity is easily remembered because of it.
