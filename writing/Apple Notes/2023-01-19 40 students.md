...
TTS with some prominence control

LLMs for p-probs to illustrate prominence
Using pre-defined texts

Give to Cristina of Eva for synthesis

Needs a listening experiment

=====

Forced alignment

Word boundary adaptation
